$.fn.progressScroll=function(e){
    var r = $.extend({ width: 50, height: 50, borderSize: 6, mainBgColor: "rgba(var(--bs-primary-rgb), .8)", lightBorderColor: "var(--bs-secondary)", darkBorderColor: "var(--bs-primary)", fontSize: "20px" }, e);
    var t,
        i,
        n,
        o = this,
